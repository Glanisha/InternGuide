  ...
  return (
    <div className="bg-neutral-900/60 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-sm text-white w-full">
      ...
      <div className="mt-8 pt-6 border-t border-white/10 flex justify-end gap-4">
        <button className="px-6 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-all font-medium">
          Chat with Mentor
        </button>
        <button className="px-6 py-2 bg-green-600 hover:bg-green-700 rounded-lg transition-all font-medium">
          Submit to Mentor
        </button>
      </div>
    </div>
