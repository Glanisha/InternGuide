  ...
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden">
      ...
      <div className={`lg:hidden fixed inset-0 z-40 ${sidebarOpen ? 'block' : 'hidden'}`}>
        <div className="absolute inset-0 bg-black opacity-80" onClick={toggleSidebar}></div>
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-64 bg-gray-900 bg-opacity-50 backdrop-blur-lg rounded-r-lg border border-gray-700 p-4 transform transition-all duration-300">
      ...
      {/* Sidebar - Desktop */}
      <aside className="hidden lg:flex flex-col w-64 bg-gray-900 bg-opacity-50 backdrop-blur-lg border-r border-gray-700">
        <div className="p-4">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Bar */}
        <header className="bg-gray-900 bg-opacity-50 backdrop-blur-lg border-b border-gray-700 p-4">
          <div className="flex items-center justify-between">
            <button onClick={toggleSidebar} className="p-2 rounded-md hover:bg-gray-800 lg:hidden">
              <MenuIcon size={24} />
            </button>
            <div className="flex-1 flex justify-end">
              <button className="px-4 py-2 bg-red-600 rounded-md hover:bg-red-700 transition-colors">
                Logout
              </button>
            </div>
          </div>
        ...
        <main className="flex-1 overflow-y-auto bg-black p-4">
          {error && (
            <div className="col-span-12 bg-red-900 bg-opacity-50 text-red-200 p-4 mb-4 rounded-lg">
              {error}
          ...
          <div className="grid grid-cols-12 gap-4">
            {currentTab === 'dashboard' && (
              <>
                ...
                {/* Recent Internships */}
                <div className="col-span-12 bg-gray-900 bg-opacity-50 backdrop-blur-lg rounded-lg border border-gray-700 p-6">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-semibold">Recent Internships</h2>
                    <button 
                      onClick={() => setCurrentTab('create')}
                      className="px-3 py-1 bg-blue-600 rounded-md hover:bg-blue-700 transition-colors flex items-center gap-2"
                    >
                      <Plus size={16} />
                      Add New
                    </button>
                      ...
                      <table className="min-w-full divide-y divide-gray-700">
                        ...
                        <tbody className="divide-y divide-gray-700">
                          {internships.map((internship) => (
                            <tr key={internship._id} className="hover:bg-gray-800 hover:bg-opacity-50 transition-colors">
                ...
                <div className="col-span-12 bg-gray-900 bg-opacity-50 backdrop-blur-lg rounded-lg border border-gray-700 p-6">
                  <div className="mb-4">
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        className="block w-full pl-10 pr-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-gray-800 border border-gray-700 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        />
                      </div>
            ...
            {currentTab === 'mentors' && (
              <>
                <div className="col-span-12 mb-6">
                  <h1 className="text-4xl font-bold">Mentor Assignment</h1>
                </div>
                
                <div className="col-span-12 bg-gray-900 bg-opacity-50 backdrop-blur-lg rounded-lg border border-gray-700 p-6">
                  <div className="text-center py-8">
                    <h2 className="text-xl font-semibold mb-4">Automatic Mentor Assignment</h2>
...
function StatCard({ title, value, color }) {
  return (
    <div className="bg-gray-900 bg-opacity-50 backdrop-blur-lg rounded-lg border border-gray-700 p-6 transition-transform hover:transform hover:scale-105">
